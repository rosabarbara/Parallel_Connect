...
class JeffChatViewModel : ViewModel() {
    ...
    private fun setupChatListener() {
        ...
        if (userId != currentUserId) {
            ...
            if (currentUserId != null) {
                ...
                messagesRef = database.getReference("chats/Jeff/$currentUserId")
    ...
    fun sendMessage(userMessage: String) {
        ...
        viewModelScope.launch {
            ...
            chatMessages.add("Jeff: $botResponse") // Add the bot's response
    ...
    private suspend fun generateBotResponse(userMessage: String): String? {
        ...
        // Define the prompt
        val prompt = "You are an old spirit, called Jeff, who died changing a lamp of a car. Answer this: $userMessage"
    ...
    private fun pushMessageToFirebase(message: String) {
        val userId = auth.currentUser?.uid
        if (userId != null) {
            val chatRef = database.getReference("chats/Jeff/$userId")
