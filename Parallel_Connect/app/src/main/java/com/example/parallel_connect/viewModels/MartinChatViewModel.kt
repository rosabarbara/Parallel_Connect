...
class MartinChatViewModel : ViewModel() {
    ...
    private fun setupChatListener() {
        ...
        if (userId != currentUserId) {
            ...
            if (currentUserId != null) {
                ...
                messagesRef = database.getReference("chats/Martin/$currentUserId")
    ...
    fun sendMessage(userMessage: String) {
        ...
        viewModelScope.launch {
            ...
            chatMessages.add("Martin: $botResponse") // Add the bot's response
    ...
    private suspend fun generateBotResponse(userMessage: String): String? {
        ...
        // Define the prompt
        val prompt = "You are an old spirit, called Martin, and you are happier than ever even dead. Answer this: $userMessage"
    ...
    private fun pushMessageToFirebase(message: String) {
        val userId = auth.currentUser?.uid
        if (userId != null) {
            val chatRef = database.getReference("chats/Martin/$userId")
